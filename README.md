...
<html>
<head>
<title>Nguyễn Trọng Thành </title>
<meta charset="UTF-8">
...
.bgimg {background-image: url("/CSS/image/anhmot.jpg")}
.bgimg2 {background-image: url("/CSS/image/anhba.jpg")}
</style>
</head>
<body>
...
<header class="w3-display-container w3-wide bgimg w3-grayscale-min" id="home">
  <div class="w3-display-middle w3-text-white w3-center">
    <h1 class="w3-jumbo"> Chào mừng bạn đến với fanpgae của tôi  </h1>
    <h2>Trọng Thành và những người bạn </h2>
    <h2><b></b></h2>
  </div>
</header>
...
<div class="w3-bottom w3-hide-small">
  <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
    ...
    <a href="#us" style="width:25%" class="w3-bar-item w3-button">Peter & Marry </a>
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min" id="us">
  <div class="w3-content">
    <h1 class="w3-center w3-text-grey"><b>Peter & Marry </b></h1>
    <img class="w3-round w3-grayscale-min" src="/CSS/image/anhhai.jpg" style="width:100%;margin:32px 0">
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min w3-center" id="wedding">
  <div class="w3-content">
    ...
    <img class="w3-round-large w3-grayscale-min" src="/CSS/image/anhbon.jpg" style="width:100%;margin:64px 0">
    <div class="w3-row">
      <div class="w3-half">
        <h2>When</h2>
...
<footer class="w3-center w3-black w3-padding-16">
  <p>Powered by <a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" class="w3-hover-text-green">https://www.facebook.com/</a></p>
</footer>
